...
function CandidateDashboard() {
  ...
  const handleApply = async () => {
    ...
    formData.append("email", "candidate@demo.com");
    ...
    <div style={{ padding: "30px", fontFamily: "Arial" }}>
      ...
      {selectedInternship && (
        <div style={formBox}>
          ...
          <button onClick={handleApply} style={submitBtn}>Submit Application</button>
        </div>
      )}
          ...
          <div key={app.id} style={card}>
            ...
            {app.interviewStatus && (
              <p style={{ color: "green", fontWeight: "bold" }}>
                {app.interviewLevel} Scheduled on {app.interviewDate} at {app.interviewTime}
              </p>
            )}
...
const testBtn = { padding: "8px 15px", background: "orange", color: "#fff", border: "none", borderRadius: 5 };
